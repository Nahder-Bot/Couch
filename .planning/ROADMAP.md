...
- [ ] 15.5-06-PLAN.md — Stale-wp 5h filter + Past parties surface (WP_STALE_MS, renderWatchpartyBanner split, openPastParties + renderPastParties, modal scaffold + CSS) [Wave 2]
