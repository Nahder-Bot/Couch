...
| 20. Decision Explanation | 0/? | **SCOPED 2026-04-29, awaiting kickoff** — Cross-AI review 2026-04-28 (Codex): families ask why did it pick this? A small explanation layer reduces distrust on matches/spin-pick. Builds buildMatchExplanation(t, couch) helper returning humility-voiced strings like Nahder + Zoey said yes · Available on Max · 165 min, surfaced on (a) spin-pick result, (b) match-card tap-to-reveal footer, (c) detail-modal Why this is in your matches section. No new data — composes from existing t.votes / t.providers / t.runtime / t.vetoes. Single-repo couch only. | - |
