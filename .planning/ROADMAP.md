...
| 15.1. Security Hardening | 2/3 | **EXECUTING — Wave 1 + Wave 2 SHIPPED 2026-04-27** — Wave 1 (15.1-01) all 3 client-side prep tasks committed (1443fa6 dotted-path progress writers + 2e61547 actingTupleKey stamping + 8dc9c52 pencil-glyph participant gate + setBy attribution). Wave 2 (15.1-02) all 3 rule + test tasks committed (7ab3015 SEC-15-1-02 anchor + SEC-15-1-01 progress sub-rule + 5b5fdb7 SEC-15-1-03 family-doc participant check + 5d605f4 tests #33-#38). 38/38 rules tests passing. Source + mirror firestore.rules byte-identical. Closes SEC-15-1-01..04 (rule + test halves) + SEC-15-1-05 (client-side from Wave 1). Awaits Wave 3 (15.1-03 — close-out + cross-repo deploy in REVERSED order: HOSTING FIRST → RULES SECOND). Scope locked in `.planning/todos/pending/2026-04-27-phase-15-security-hardening-pass.md`; evidence in `.planning/phases/15-tracking-layer/15-SECURITY.md` + `15-REVIEW.md`. **Inserted as decimal phase (mirrors 03.5 precedent), NOT a slot reassignment.** | 15.1-02 shipped 2026-04-27 |
