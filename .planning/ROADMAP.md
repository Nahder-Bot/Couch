...
| 14. Decision Ritual Core | 0/9 | **PLANNED 2026-04-25** — 9 plans across 4 waves ready to execute; 13 DECI-14-* requirements minted. Wave 1 (foundations): 14-01 already-watched filter, 14-02 queue polish (DR-2 reframe), 14-04 SVG couch viz, 14-05 tile redesign, 14-06 extend intents collection (DR-1 — extends Phase 8 primitive, NOT a new collection). Wave 2: 14-03 tier aggregators, 14-08 Flow B nominate. Wave 3: 14-07 Flow A rank-pick. Wave 4: 14-09 onboarding tooltips + 5 empty states + 7 push categories (DR-3 — 3 places per CONTEXT override) + sw.js v34 CACHE bump + ordered cross-repo deploy. CONTEXT updated 2026-04-25 with DR-3 follow-up override (D-12 friendly-UI parity deferred). Run `/gsd-execute-phase 14` to begin. **Originally tagged Phase 13 — see Phase-slot history below.** | - |
