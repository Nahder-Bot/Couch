...
last_updated: "2026-04-29T23:32:32.427Z"
progress:
  total_phases: 17
  completed_phases: 13
  total_plans: 82
...
Current source: `couch-v36-availability-notifs` (Plan 18-04 — Wave 2 close-out **DEPLOYED 2026-04-29** via STANDARD cross-repo deploy ritual: queuenight `firebase deploy --only functions` first at 22:48Z, then couch `bash scripts/deploy.sh 36-availability-notifs` at 22:50Z). Live on couchtonight.app: `couch-v36-availability-notifs` (curl-verified). Bumped via `bash scripts/deploy.sh <short-tag>`. Phase progression: v29 (P11 final) → v32 (P12) → v33 (P13) → v34.0/v34.1 (P14) → v35.0/v35.0.1 (P15) → v35.1-security-hardening (P15.1 / 15.1-03) → v35.5-wait-up-flex (P15.5 / 15.5-07 — DEPLOYED 2026-04-28; followed by 5 same-day Tonight-surface hotfixes 35.5.1-35.5.5) → v35.6-integration-polish (P15.4 / 15.4-03 — DEPLOYED 2026-04-29) → v36-availability-notifs (P18 / 18-04 — **DEPLOYED 2026-04-29**; ships providerRefreshTick scheduled CF + titleAvailable push event-type + manual refresh affordance + via-TMDB attribution; UAT pending).
