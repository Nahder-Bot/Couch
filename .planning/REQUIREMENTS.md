...
| DECI-14-12 | Phase 14 Plan 09 | Complete — DEPLOY-DEFERRED (2026-04-26; commit e572467 + queuenight uncommitted; 7 D-12 push categories added in THREE places per DR-3 — server NOTIFICATION_DEFAULTS in queuenight/functions/index.js (uncommitted on this machine — same pattern as 14-06 deviation 1) + client DEFAULT_NOTIFICATION_PREFS at js/app.js:100 + client NOTIFICATION_EVENT_LABELS at js/app.js:113 with BRAND-voice copy; all 7 default ON per RESEARCH §5; DR-3 follow-up override applied — friendly-UI maps NOT mirrored to avoid dual-Settings-screen collision RESEARCH §5 flagged; friendly-UI parity captured as polish backlog; recap in 14-09-SUMMARY.md) |
